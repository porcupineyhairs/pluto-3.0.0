...
/**
 * <span class="changed_modified_3_0">The</span> <CODE>WindowState</CODE> class represents the possible window states
...
public class WindowState {
   ...
   /**
    * <div class="changed_added_3_0"> The window state <code>UNDEFINED</code> is returned by the
