 ...
 * portlet DispatcherReqRespTests5S_SPEC2_19_ForwardJSPActionRequest_event
 *
 */
public class DispatcherReqRespTests5S_SPEC2_19_ForwardJSPActionRequest implements Portlet, ResourceServingPortlet {
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      String msg = (String) ps.getAttribute(RESULT_ATTR_PREFIX + "DispatcherReqRespTests5S_SPEC2_19_ForwardJSPActionRequest", APPLICATION_SCOPE);
      if (msg != null) {
         writer.write("<p>" + msg + "</p><br/>\n");
         ps.removeAttribute(RESULT_ATTR_PREFIX + "DispatcherReqRespTests5S_SPEC2_19_ForwardJSPActionRequest", APPLICATION_SCOPE);
      }
