...
<%
      ...
      TestResult tr0 = tcd.getTestResultSucceeded(V2DISPATCHERREQRESPTESTS5S_SPEC2_19_FORWARDJSPRENDERRESPONSE_GETOUTPUTSTREAM);
      ...
      /* operation"                                                           */
      TestResult tr1 = tcd.getTestResultSucceeded(V2DISPATCHERREQRESPTESTS5S_SPEC2_19_FORWARDJSPRENDERRESPONSE_SENDERROR);
      ...
      /* operation"                                                           */
      TestResult tr2 = tcd.getTestResultSucceeded(V2DISPATCHERREQRESPTESTS5S_SPEC2_19_FORWARDJSPRENDERRESPONSE_SENDREDIRECT);
      ...
      /* any operation"                                                       */
      TestResult tr3 = tcd.getTestResultSucceeded(V2DISPATCHERREQRESPTESTS5S_SPEC2_19_FORWARDJSPRENDERRESPONSE_SETCHARACTERENCODING);
      ...
      /* operation"                                                           */
      TestResult tr4 = tcd.getTestResultSucceeded(V2DISPATCHERREQRESPTESTS5S_SPEC2_19_FORWARDJSPRENDERRESPONSE_SETCONTENTLENGTH);
      ...
      TestResult tr5 = tcd.getTestResultSucceeded(V2DISPATCHERREQRESPTESTS5S_SPEC2_19_FORWARDJSPRENDERRESPONSE_SETCONTENTTYPE);
      ...
      /* operation"                                                           */
      TestResult tr6 = tcd.getTestResultSucceeded(V2DISPATCHERREQRESPTESTS5S_SPEC2_19_FORWARDJSPRENDERRESPONSE_SETLOCALE);
      ...
      /* operation"                                                           */
      TestResult tr7 = tcd.getTestResultSucceeded(V2DISPATCHERREQRESPTESTS5S_SPEC2_19_FORWARDJSPRENDERRESPONSE_SETSTATUS);
