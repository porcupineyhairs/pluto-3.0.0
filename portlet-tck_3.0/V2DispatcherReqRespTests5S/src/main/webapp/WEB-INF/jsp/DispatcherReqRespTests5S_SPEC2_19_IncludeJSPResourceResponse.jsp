...
<%
      ...
      TestResult tr0 = tcd.getTestResultSucceeded(V2DISPATCHERREQRESPTESTS5S_SPEC2_19_INCLUDEJSPRESOURCERESPONSE_GETOUTPUTSTREAM);
      ...
      /* operation"                                                           */
      TestResult tr1 = tcd.getTestResultSucceeded(V2DISPATCHERREQRESPTESTS5S_SPEC2_19_INCLUDEJSPRESOURCERESPONSE_SENDERROR);
      ...
      /* operation"                                                           */
      TestResult tr2 = tcd.getTestResultSucceeded(V2DISPATCHERREQRESPTESTS5S_SPEC2_19_INCLUDEJSPRESOURCERESPONSE_SENDREDIRECT);
      ...
      /* any operation"                                                       */
      TestResult tr3 = tcd.getTestResultSucceeded(V2DISPATCHERREQRESPTESTS5S_SPEC2_19_INCLUDEJSPRESOURCERESPONSE_SETCHARACTERENCODING);
      ...
      /* operation"                                                           */
      TestResult tr4 = tcd.getTestResultSucceeded(V2DISPATCHERREQRESPTESTS5S_SPEC2_19_INCLUDEJSPRESOURCERESPONSE_SETCONTENTLENGTH);
      ...
      /* operation"                                                           */
      TestResult tr5 = tcd.getTestResultSucceeded(V2DISPATCHERREQRESPTESTS5S_SPEC2_19_INCLUDEJSPRESOURCERESPONSE_SETCONTENTTYPE);
      ...
      /* operation"                                                           */
      TestResult tr6 = tcd.getTestResultSucceeded(V2DISPATCHERREQRESPTESTS5S_SPEC2_19_INCLUDEJSPRESOURCERESPONSE_SETLOCALE);
      ...
      /* operation"                                                           */
      TestResult tr7 = tcd.getTestResultSucceeded(V2DISPATCHERREQRESPTESTS5S_SPEC2_19_INCLUDEJSPRESOURCERESPONSE_SETSTATUS);
