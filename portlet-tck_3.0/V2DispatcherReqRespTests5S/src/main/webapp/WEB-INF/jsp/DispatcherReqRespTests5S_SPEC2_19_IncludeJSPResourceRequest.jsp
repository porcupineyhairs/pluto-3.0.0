...
<%
      ...
      TestResult tr0 = tcd.getTestResultSucceeded(V2DISPATCHERREQRESPTESTS5S_SPEC2_19_INCLUDEJSPRESOURCEREQUEST_GETINPUTSTREAM);
      ...
      TestResult tr1 = tcd.getTestResultSucceeded(V2DISPATCHERREQRESPTESTS5S_SPEC2_19_INCLUDEJSPRESOURCEREQUEST_SETCHARACTERENCODING);
