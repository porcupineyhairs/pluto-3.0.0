...
public class AddlRequestTests_SPEC2_11_EventAttr_event implements Portlet, EventPortlet {
  ...
  public void processEvent(EventRequest portletReq, EventResponse portletResp)
    ...
    if (portletReq.getAttribute(PortletRequest.LIFECYCLE_PHASE).equals("EVENT_PHASE")) {
      tr2.setTcSuccess(true);
    }
    tr2.writeTo(writer);

    portletReq.getPortletSession().setAttribute(
        RESULT_ATTR_PREFIX + "AddlRequestTests_SPEC2_11_EventAttr", writer.toString(),
        APPLICATION_SCOPE);
  ...
  public void render(RenderRequest portletReq, RenderResponse portletResp)
    ...
    String msg = (String) portletReq.getPortletSession().getAttribute(
        RESULT_ATTR_PREFIX + "AddlRequestTests_SPEC2_11_EventAttr", APPLICATION_SCOPE);
