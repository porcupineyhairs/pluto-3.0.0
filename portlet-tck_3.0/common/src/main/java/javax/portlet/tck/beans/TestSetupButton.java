 ...
 * @author nick
 */
public class TestSetupButton extends TestButton {

   /**
    * Creates an empty test result.
    */
   public TestSetupButton() {
      super();
   }
    ...
    */
   public TestSetupButton(String tcName, PortletURL purl) {
      super(tcName, purl);
      actId = tcName + Constants.SETUP_ID;
      paramName = tcName + Constants.SETUP_ID;
      this.title = " Setup Button:";
   }
