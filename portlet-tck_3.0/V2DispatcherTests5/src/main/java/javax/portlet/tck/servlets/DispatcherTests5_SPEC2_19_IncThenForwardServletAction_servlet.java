 ...
 * DispatcherTests5_SPEC2_19_IncThenForwardServletAction
 * 
 * @author nick
 * 
 */
public class DispatcherTests5_SPEC2_19_IncThenForwardServletAction_servlet extends HttpServlet {
   ...
   protected void processTCKReq(HttpServletRequest request, HttpServletResponse response) throws ServletException,
      ...
      request.getSession().setAttribute(
            Constants.RESULT_ATTR_PREFIX + "DispatcherTests5_SPEC2_19_IncThenForwardServletAction", writer.toString());
