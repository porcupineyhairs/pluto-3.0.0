...
/**
 * Servlet for JSR 362 request dispatcher testing. Used by portlet: DispatcherTests5_SPEC2_19_IncThenForwardServletEvent
 * 
 * @author nick
 * 
 */
public class DispatcherTests5_SPEC2_19_IncThenForwardServletEvent_servlet extends HttpServlet {
   ...
   protected void processTCKReq(HttpServletRequest request, HttpServletResponse response) throws ServletException,
      ...
      request.getSession().setAttribute(
            Constants.RESULT_ATTR_PREFIX + "DispatcherTests5_SPEC2_19_IncThenForwardServletEvent", writer.toString());
