 ...
 * DispatcherTests5_SPEC2_19_IncThenIncludeServletRender
 * 
 * @author nick
 * 
 */
public class DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_servlet extends HttpServlet {
   ...
   protected void processTCKReq(HttpServletRequest request, HttpServletResponse response) throws ServletException,
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_dispatch1 */
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_dispatch2 */
      ...
      TestResult tr1 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_DISPATCH2);
      try {
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_dispatch3 */
      /* Details: "In a servlet included by the target of an include, if */
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_DISPATCH3);
      try {
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_invoke2 */
      /* Details: "In a servlet included by the target of an include, */
      ...
      TestResult tr3 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_INVOKE2);
      try {
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_invoke4 */
      ...
      TestResult tr4 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_INVOKE4);
      try {
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_invoke7 */
      /* Details: "In a servlet included by the target of an include, the */
      ...
      TestResult tr5 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_INVOKE7);
      try {
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_invoke9 */
      /* Details: "In a servlet included by the target of an include, the */
      /* included servlet must be handled as an HTTP GET request" */
      TestResult tr6 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_INVOKE9);
      try {
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_attributes1 */
      /* Details: "In a servlet included by the target of an include, the */
      ...
      TestResult tr7 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_ATTRIBUTES1);
      try {
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_attributes1a */
      /* Details: "In a servlet included by the target of an include, the */
      /* servlet request attribute javax.servlet.include.request_uri will */
      /* be set, and reflects the path values of the included servlet." */
      TestResult tr8 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_ATTRIBUTES1A);
      try {
         String name = "javax.servlet.include.request_uri";
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_attributes1b */
      /* Details: "In a servlet included by the target of an include, the */
      /* portlet request attribute javax.servlet.forward.request_uri will */
      /* not be set" */
      TestResult tr9 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_ATTRIBUTES1B);
      try {
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_attributes1c */
      /* Details: "In a servlet included by the target of an include, the */
      /* servlet request attribute javax.servlet.forward.request_uri will */
      /* not be set" */
      TestResult tr10 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_ATTRIBUTES1C);
      try {
         String name = "javax.servlet.forward.request_uri";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_attributes2 */
      /* Details: "In a servlet included by the target of an include, the */
      /* portlet request attribute javax.servlet.include.context_path will */
      /* be set, and reflects the path values of the included servlet." */
      TestResult tr11 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_ATTRIBUTES2);
      try {
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_attributes2a */
      /* Details: "In a servlet included by the target of an include, the */
      /* servlet request attribute javax.servlet.include.context_path will */
      /* be set, and reflects the path values of the included servlet." */
      TestResult tr12 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_ATTRIBUTES2A);
      try {
         String name = "javax.servlet.include.context_path";
         String attrVal = (String) request.getAttribute(name);
         String currVal = fsfcContext_path;
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_attributes2b */
      /* Details: "In a servlet included by the target of an include, the */
      /* portlet request attribute javax.servlet.forward.context_path will */
      /* not be set" */
      TestResult tr13 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_ATTRIBUTES2B);
      try {
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_attributes2c */
      /* Details: "In a servlet included by the target of an include, the */
      /* servlet request attribute javax.servlet.forward.context_path will */
      /* not be set" */
      TestResult tr14 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_ATTRIBUTES2C);
      try {
         String name = "javax.servlet.forward.context_path";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_attributes3 */
      /* Details: "In a servlet included by the target of an include, the */
      /* portlet request attribute javax.servlet.include.servlet_path will */
      /* be set, and reflects the path values of the included servlet." */
      TestResult tr15 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_ATTRIBUTES3);
      try {
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_attributes3a */
      /* Details: "In a servlet included by the target of an include, the */
      /* servlet request attribute javax.servlet.include.servlet_path will */
      /* be set, and reflects the path values of the included servlet." */
      TestResult tr16 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_ATTRIBUTES3A);
      try {
         String name = "javax.servlet.include.servlet_path";
         String attrVal = (String) request.getAttribute(name);
         String currVal = fsfcServlet_path;
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_attributes3b */
      /* Details: "In a servlet included by the target of an include, the */
      /* portlet request attribute javax.servlet.forward.servlet_path will */
      /* not be set" */
      TestResult tr17 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_ATTRIBUTES3B);
      try {
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_attributes3c */
      /* Details: "In a servlet included by the target of an include, the */
      /* servlet request attribute javax.servlet.forward.servlet_path will */
      /* not be set" */
      TestResult tr18 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_ATTRIBUTES3C);
      try {
         String name = "javax.servlet.forward.servlet_path";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_attributes4 */
      /* Details: "In a servlet included by the target of an include, the */
      ...
      TestResult tr19 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_ATTRIBUTES4);
      try {
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_attributes4a */
      /* Details: "In a servlet included by the target of an include, the */
      /* servlet request attribute javax.servlet.include.path_info will be */
      /* set, and reflects the path values of the included servlet." */
      TestResult tr20 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_ATTRIBUTES4A);
      try {
         String name = "javax.servlet.include.path_info";
         String attrVal = (String) request.getAttribute(name);
         String currVal = fsfcPath_info;
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_attributes4b */
      /* Details: "In a servlet included by the target of an include, the */
      /* portlet request attribute javax.servlet.forward.path_info will not */
      /* be set" */
      TestResult tr21 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_ATTRIBUTES4B);
      try {
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_attributes4c */
      /* Details: "In a servlet included by the target of an include, the */
      /* servlet request attribute javax.servlet.forward.path_info will not */
      /* be set" */
      TestResult tr22 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_ATTRIBUTES4C);
      try {
         String name = "javax.servlet.forward.path_info";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_attributes5 */
      /* Details: "In a servlet included by the target of an include, the */
      /* portlet request attribute javax.servlet.include.query_string will */
      /* be set, and reflects the path values of the included servlet." */
      TestResult tr23 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_ATTRIBUTES5);
      try {
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_attributes5a */
      /* Details: "In a servlet included by the target of an include, the */
      /* servlet request attribute javax.servlet.include.query_string will */
      /* be set, and reflects the path values of the included servlet." */
      TestResult tr24 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_ATTRIBUTES5A);
      try {
         String name = "javax.servlet.include.query_string";
         String attrVal = (String) request.getAttribute(name);
         String currVal = fsfcQuery_string;
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_attributes5b */
      /* Details: "In a servlet included by the target of an include, the */
      /* portlet request attribute javax.servlet.forward.query_string will */
      /* not be set" */
      TestResult tr25 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_ATTRIBUTES5B);
      try {
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_attributes5c */
      /* Details: "In a servlet included by the target of an include, the */
      /* servlet request attribute javax.servlet.forward.query_string will */
      /* not be set" */
      TestResult tr26 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_ATTRIBUTES5C);
      try {
         String name = "javax.servlet.forward.query_string";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_attributes6 */
      /* Details: "In a servlet included by the target of an include, the */
      /* request attribute javax.portlet.config must be set to the */
      /* javax.portlet.PortletConfig object" */
      TestResult tr27 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_ATTRIBUTES6);
      try {
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_attributes7 */
      ...
      TestResult tr28 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_ATTRIBUTES7);
      try {
      ...
      /* TestCase: V2DispatcherTests5_SPEC2_19_IncThenIncludeServletRender_attributes8 */
      /* Details: "In a servlet included by the target of an include, for */
      /* includes from the render method, The request attribute */
      /* javax.portlet.response must be set to the */
      /* javax.portlet.RenderResponse object" */
      TestResult tr29 = tcd.getTestResultFailed(V2DISPATCHERTESTS5_SPEC2_19_INCTHENINCLUDESERVLETRENDER_ATTRIBUTES8);
      try {
