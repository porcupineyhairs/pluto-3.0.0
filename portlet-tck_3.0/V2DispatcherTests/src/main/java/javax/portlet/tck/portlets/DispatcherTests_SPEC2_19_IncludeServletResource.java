 ...
 * DispatcherTests_SPEC2_19_IncludeServletResource_event
 * 
 */
public class DispatcherTests_SPEC2_19_IncludeServletResource implements Portlet, ResourceServingPortlet {
   ...
   public void serveResource(ResourceRequest portletReq, ResourceResponse portletResp) throws PortletException,
      ...
      String target = SERVLET_PREFIX + "DispatcherTests_SPEC2_19_IncludeServletResource_servlet" + SERVLET_SUFFIX + "?"
            + QUERY_STRING;
