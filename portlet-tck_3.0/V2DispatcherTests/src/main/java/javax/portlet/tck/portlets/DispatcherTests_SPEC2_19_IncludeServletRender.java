 ...
 * DispatcherTests_SPEC2_19_IncludeServletRender_event
 * 
 */
public class DispatcherTests_SPEC2_19_IncludeServletRender implements Portlet, ResourceServingPortlet {
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp) throws PortletException, IOException {
      ...
      String target = SERVLET_PREFIX + "DispatcherTests_SPEC2_19_IncludeServletRender_servlet" + SERVLET_SUFFIX + "?"
            + QUERY_STRING;
