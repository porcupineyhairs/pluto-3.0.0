...
/**
 * Servlet for JSR 362 request dispatcher testing. Used by portlet: DispatcherTests_SPEC2_19_ForwardServletAction
 * 
 * @author nick
 * 
 */
public class DispatcherTests_SPEC2_19_ForwardServletAction_servlet extends HttpServlet {
   ...
   protected void processTCKReq(HttpServletRequest request, HttpServletResponse response) throws ServletException,
      ...
      TestResult tr0 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_DISPATCH1);
      try {
      ...
      TestResult tr1 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_DISPATCH2);
      try {
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_DISPATCH3);
      try {
         String qparm1 = portletReq.getParameter("qparm1");
         String qparm2 = portletReq.getParameter("qparm2");
         boolean ok = ((qparm1 != null) && (qparm2 != null));
      ...
      try {
         String sname = SERVLET_PREFIX + "DispatcherTests_SPEC2_19_ForwardServletAction_servlet" + SERVLET_SUFFIX;
      ...
      /* value from HTTPServletRequest.getRequestURI for the first servlet */
      /* in the forward chain" */
      TestResult tr8 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_ATTRIBUTES1A);
      try {
         String name = "javax.servlet.forward.request_uri";
      ...
      TestResult tr9 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_ATTRIBUTES1B);
      try {
      ...
      /* getRequestDispatcher method, the servlet request attribute */
      /* javax.servlet.include.request_uri will not be set" */
      TestResult tr10 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_ATTRIBUTES1C);
      try {
         String name = "javax.servlet.include.request_uri";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      /* in the forward chain" */
      TestResult tr11 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_ATTRIBUTES2);
      try {
      ...
      /* value from HTTPServletRequest.getContextPath for the first servlet */
      /* in the forward chain" */
      TestResult tr12 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_ATTRIBUTES2A);
      try {
         String name = "javax.servlet.forward.context_path";
         String attrVal = (String) request.getAttribute(name);
         String currVal = request.getContextPath();
      ...
      TestResult tr13 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_ATTRIBUTES2B);
      try {
      ...
      /* getRequestDispatcher method, the servlet request attribute */
      /* javax.servlet.include.context_path will not be set" */
      TestResult tr14 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_ATTRIBUTES2C);
      try {
         String name = "javax.servlet.include.context_path";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      /* in the forward chain" */
      TestResult tr15 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_ATTRIBUTES3);
      try {
      ...
      /* value from HTTPServletRequest.getServletPath for the first servlet */
      /* in the forward chain" */
      TestResult tr16 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_ATTRIBUTES3A);
      try {
         String name = "javax.servlet.forward.servlet_path";
         String attrVal = (String) request.getAttribute(name);
         String currVal = request.getServletPath();
      ...
      TestResult tr17 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_ATTRIBUTES3B);
      try {
      ...
      /* getRequestDispatcher method, the servlet request attribute */
      /* javax.servlet.include.servlet_path will not be set" */
      TestResult tr18 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_ATTRIBUTES3C);
      try {
         String name = "javax.servlet.include.servlet_path";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      /* forward chain" */
      TestResult tr19 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_ATTRIBUTES4);
      try {
      ...
      /* from HTTPServletRequest.getPathInfo for the first servlet in the */
      /* forward chain" */
      TestResult tr20 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_ATTRIBUTES4A);
      try {
         String name = "javax.servlet.forward.path_info";
         String attrVal = (String) request.getAttribute(name);
         String currVal = request.getPathInfo();
      ...
      TestResult tr21 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_ATTRIBUTES4B);
      try {
      ...
      /* getRequestDispatcher method, the servlet request attribute */
      /* javax.servlet.include.path_info will not be set" */
      TestResult tr22 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_ATTRIBUTES4C);
      try {
         String name = "javax.servlet.include.path_info";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      /* in the forward chain" */
      TestResult tr23 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_ATTRIBUTES5);
      try {
      ...
      /* value from HTTPServletRequest.getQueryString for the first servlet */
      /* in the forward chain" */
      TestResult tr24 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_ATTRIBUTES5A);
      try {
         String name = "javax.servlet.forward.query_string";
         String attrVal = (String) request.getAttribute(name);
         String currVal = request.getQueryString();
      ...
      TestResult tr25 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_ATTRIBUTES5B);
      try {
      ...
      /* getRequestDispatcher method, the servlet request attribute */
      /* javax.servlet.include.query_string will not be set" */
      TestResult tr26 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_ATTRIBUTES5C);
      try {
         String name = "javax.servlet.include.query_string";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      TestResult tr27 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_ATTRIBUTES6);
      try {
      ...
      TestResult tr28 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_ATTRIBUTES7);
      try {
      ...
      TestResult tr29 = tcd.getTestResultFailed(V2DISPATCHERTESTS_SPEC2_19_FORWARDSERVLETACTION_ATTRIBUTES8);
      try {
      ...
      request.getSession().setAttribute(Constants.RESULT_ATTR_PREFIX + "DispatcherTests_SPEC2_19_ForwardServletAction",
            writer.toString());
