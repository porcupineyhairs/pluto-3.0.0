 ...
 * DispatcherTests6_SPEC2_19_FwdThenForwardServletAction
 * 
 * @author nick
 * 
 */
public class DispatcherTests6_SPEC2_19_FwdThenForwardServletAction_servlet extends HttpServlet {
   ...
   protected void processTCKReq(HttpServletRequest request, HttpServletResponse response) throws ServletException,
      ...
      TestResult tr0 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_DISPATCH1);
      try {
      ...
      TestResult tr1 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_DISPATCH2);
      try {
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_DISPATCH3);
      try {
         String qparm1 = portletReq.getParameter("qparm1");
         String qparm2 = portletReq.getParameter("qparm2");
         boolean ok = ((qparm1 != null) && (qparm2 != null));
      ...
      TestResult tr3 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_INVOKE2);
      try {
      ...
      TestResult tr4 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_INVOKE4);
      try {
      ...
      /* RequestDispatcher" */
      TestResult tr5 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_INVOKE7);
      try {
      ...
      /* forward chain" */
      TestResult tr6 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_ATTRIBUTES1);
      try {
      ...
      /* HTTPServletRequest.getRequestURI for the first servlet in the */
      /* forward chain" */
      TestResult tr7 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_ATTRIBUTES1A);
      try {
         String name = "javax.servlet.forward.request_uri";
      ...
      /* will not be set" */
      TestResult tr8 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_ATTRIBUTES1B);
      try {
      ...
      /* will not be set" */
      TestResult tr9 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_ATTRIBUTES1C);
      try {
         String name = "javax.servlet.include.request_uri";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      /* forward chain" */
      TestResult tr10 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_ATTRIBUTES2);
      try {
      ...
      /* HTTPServletRequest.getContextPath for the first servlet in the */
      /* forward chain" */
      TestResult tr11 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_ATTRIBUTES2A);
      try {
         String name = "javax.servlet.forward.context_path";
         String attrVal = (String) request.getAttribute(name);
         String currVal = fsfcContext_path;
      ...
      /* will not be set" */
      TestResult tr12 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_ATTRIBUTES2B);
      try {
      ...
      /* will not be set" */
      TestResult tr13 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_ATTRIBUTES2C);
      try {
         String name = "javax.servlet.include.context_path";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      /* forward chain" */
      TestResult tr14 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_ATTRIBUTES3);
      try {
      ...
      /* HTTPServletRequest.getServletPath for the first servlet in the */
      /* forward chain" */
      TestResult tr15 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_ATTRIBUTES3A);
      try {
         String name = "javax.servlet.forward.servlet_path";
         String attrVal = (String) request.getAttribute(name);
         String currVal = fsfcServlet_path;
      ...
      /* will not be set" */
      TestResult tr16 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_ATTRIBUTES3B);
      try {
      ...
      /* will not be set" */
      TestResult tr17 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_ATTRIBUTES3C);
      try {
         String name = "javax.servlet.include.servlet_path";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      TestResult tr18 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_ATTRIBUTES4);
      try {
      ...
      /* be set, and equals the value from HTTPServletRequest.getPathInfo */
      /* for the first servlet in the forward chain" */
      TestResult tr19 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_ATTRIBUTES4A);
      try {
         String name = "javax.servlet.forward.path_info";
         String attrVal = (String) request.getAttribute(name);
         String currVal = fsfcPath_info;
      ...
      /* not be set" */
      TestResult tr20 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_ATTRIBUTES4B);
      try {
      ...
      /* not be set" */
      TestResult tr21 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_ATTRIBUTES4C);
      try {
         String name = "javax.servlet.include.path_info";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      /* forward chain" */
      TestResult tr22 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_ATTRIBUTES5);
      try {
      ...
      /* HTTPServletRequest.getQueryString for the first servlet in the */
      /* forward chain" */
      TestResult tr23 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_ATTRIBUTES5A);
      try {
         String name = "javax.servlet.forward.query_string";
         String attrVal = (String) request.getAttribute(name);
         String currVal = fsfcQuery_string;
      ...
      /* will not be set" */
      TestResult tr24 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_ATTRIBUTES5B);
      try {
      ...
      /* will not be set" */
      TestResult tr25 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_ATTRIBUTES5C);
      try {
         String name = "javax.servlet.include.query_string";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      TestResult tr26 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_ATTRIBUTES6);
      try {
      ...
      TestResult tr27 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_ATTRIBUTES7);
      try {
      ...
      TestResult tr28 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENFORWARDSERVLETACTION_ATTRIBUTES8);
      try {
      ...
      request.getSession().setAttribute(
            Constants.RESULT_ATTR_PREFIX + "DispatcherTests6_SPEC2_19_FwdThenForwardServletAction", writer.toString());
