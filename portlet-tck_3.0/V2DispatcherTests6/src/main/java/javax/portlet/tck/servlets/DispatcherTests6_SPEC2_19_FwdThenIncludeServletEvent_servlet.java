...
/**
 * Servlet for JSR 362 request dispatcher testing. Used by portlet: DispatcherTests6_SPEC2_19_FwdThenIncludeServletEvent
 * 
 * @author nick
 * 
 */
public class DispatcherTests6_SPEC2_19_FwdThenIncludeServletEvent_servlet extends HttpServlet {
   ...
   protected void processTCKReq(HttpServletRequest request, HttpServletResponse response) throws ServletException,
      ...
      TestResult tr0 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_DISPATCH1);
      try {
      ...
      TestResult tr1 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_DISPATCH2);
      try {
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_DISPATCH3);
      try {
         String qparm1 = portletReq.getParameter("qparm1");
         String qparm2 = portletReq.getParameter("qparm2");
         boolean ok = ((qparm1 != null) && (qparm2 != null));
      ...
      TestResult tr3 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_INVOKE2);
      try {
      ...
      TestResult tr4 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_INVOKE4);
      try {
      ...
      TestResult tr5 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_INVOKE7);
      try {
      ...
      TestResult tr6 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_ATTRIBUTES1);
      try {
      ...
      /* be set, and reflects the path values of the included servlet." */
      TestResult tr7 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_ATTRIBUTES1A);
      try {
         String name = "javax.servlet.include.request_uri";
      ...
      /* not be set" */
      TestResult tr8 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_ATTRIBUTES1B);
      try {
      ...
      /* not be set" */
      TestResult tr9 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_ATTRIBUTES1C);
      try {
         String name = "javax.servlet.forward.request_uri";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      /* be set, and reflects the path values of the included servlet." */
      TestResult tr10 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_ATTRIBUTES2);
      try {
      ...
      /* be set, and reflects the path values of the included servlet." */
      TestResult tr11 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_ATTRIBUTES2A);
      try {
         String name = "javax.servlet.include.context_path";
         String attrVal = (String) request.getAttribute(name);
         String currVal = fsfcContext_path;
      ...
      /* not be set" */
      TestResult tr12 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_ATTRIBUTES2B);
      try {
      ...
      /* not be set" */
      TestResult tr13 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_ATTRIBUTES2C);
      try {
         String name = "javax.servlet.forward.context_path";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      /* be set, and reflects the path values of the included servlet." */
      TestResult tr14 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_ATTRIBUTES3);
      try {
      ...
      /* be set, and reflects the path values of the included servlet." */
      TestResult tr15 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_ATTRIBUTES3A);
      try {
         String name = "javax.servlet.include.servlet_path";
         String attrVal = (String) request.getAttribute(name);
         String currVal = fsfcServlet_path;
      ...
      /* not be set" */
      TestResult tr16 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_ATTRIBUTES3B);
      try {
      ...
      /* not be set" */
      TestResult tr17 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_ATTRIBUTES3C);
      try {
         String name = "javax.servlet.forward.servlet_path";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      TestResult tr18 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_ATTRIBUTES4);
      try {
      ...
      /* set, and reflects the path values of the included servlet." */
      TestResult tr19 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_ATTRIBUTES4A);
      try {
         String name = "javax.servlet.include.path_info";
         String attrVal = (String) request.getAttribute(name);
         String currVal = fsfcPath_info;
      ...
      /* be set" */
      TestResult tr20 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_ATTRIBUTES4B);
      try {
      ...
      /* be set" */
      TestResult tr21 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_ATTRIBUTES4C);
      try {
         String name = "javax.servlet.forward.path_info";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      /* be set, and reflects the path values of the included servlet." */
      TestResult tr22 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_ATTRIBUTES5);
      try {
      ...
      /* be set, and reflects the path values of the included servlet." */
      TestResult tr23 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_ATTRIBUTES5A);
      try {
         String name = "javax.servlet.include.query_string";
         String attrVal = (String) request.getAttribute(name);
         String currVal = fsfcQuery_string;
      ...
      /* not be set" */
      TestResult tr24 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_ATTRIBUTES5B);
      try {
      ...
      /* not be set" */
      TestResult tr25 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_ATTRIBUTES5C);
      try {
         String name = "javax.servlet.forward.query_string";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      TestResult tr26 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_ATTRIBUTES6);
      try {
      ...
      TestResult tr27 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_ATTRIBUTES7);
      try {
      ...
      TestResult tr28 = tcd.getTestResultFailed(V2DISPATCHERTESTS6_SPEC2_19_FWDTHENINCLUDESERVLETEVENT_ATTRIBUTES8);
      try {
      ...
      request.getSession().setAttribute(
            Constants.RESULT_ATTR_PREFIX + "DispatcherTests6_SPEC2_19_FwdThenIncludeServletEvent", writer.toString());
