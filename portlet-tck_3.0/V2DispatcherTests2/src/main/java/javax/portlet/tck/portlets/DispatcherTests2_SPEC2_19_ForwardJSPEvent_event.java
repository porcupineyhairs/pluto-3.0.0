 ...
 */
public class DispatcherTests2_SPEC2_19_ForwardJSPEvent_event implements Portlet, EventPortlet, ResourceServingPortlet {
   ...
   public void processEvent(EventRequest portletReq, EventResponse portletResp) throws PortletException, IOException {
      ...
      String target = JSP_PREFIX + "DispatcherTests2_SPEC2_19_ForwardJSPEvent" + JSP_SUFFIX + "?" + QUERY_STRING;
