 ...
 * DispatcherTests2_SPEC2_19_IncludeJSPResource_event
 * 
 */
public class DispatcherTests2_SPEC2_19_IncludeJSPResource implements Portlet, ResourceServingPortlet {
   ...
   public void serveResource(ResourceRequest portletReq, ResourceResponse portletResp) throws PortletException,
      ...
      String target = JSP_PREFIX + "DispatcherTests2_SPEC2_19_IncludeJSPResource" + JSP_SUFFIX + "?" + QUERY_STRING;
