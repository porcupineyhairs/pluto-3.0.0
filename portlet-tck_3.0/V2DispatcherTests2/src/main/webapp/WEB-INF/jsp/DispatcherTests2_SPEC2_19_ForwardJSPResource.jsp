...
<%
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_dispatch1   */
      ...
      TestResult tr0 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_DISPATCH1);
      try {
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_dispatch3   */
      ...
      TestResult tr2 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_DISPATCH3);
      try {
         String qparm1 = portletReq.getParameter("qparm1");
         String qparm2 = portletReq.getParameter("qparm2");
         boolean ok = ((qparm1 != null) && (qparm2 != null));
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_invoke1     */
      /* Details: "The PortletRequestDispatcher forward method can target a   */
      /* servlet "                                                            */
      TestResult tr3 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_INVOKE1);
      try {
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_invoke2     */
      ...
      TestResult tr4 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_INVOKE2);
      try {
         // If this gets executed, include worked.
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_invoke4     */
      /* Details: "The portlet container must invoke the target servlet in    */
      /* the same thread as the PortletRequestDispatcher include              */
      /* invocation"                                                          */
      TestResult tr5 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_INVOKE4);
      try {
         tr5.setTcSuccess(reqTid == svtTid);
      } catch(Exception e) {tr5.appendTcDetail(e.toString());}
      tr5.writeTo(writer);

      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_invoke7     */
      /* Details: "The path elements of the request object exposed to the     */
      /* target servlet must reflect the path used to obtain the              */
      /* RequestDispatcher"                                                   */
      TestResult tr6 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_INVOKE7);
      try {
         String sname = JSP_PREFIX + "DispatcherTests2_SPEC2_19_ForwardJSPResource" + JSP_SUFFIX;
         String path= request.getServletPath();
         CompareUtils.stringsEqual(path, sname, tr6);
      } catch(Exception e) {tr6.appendTcDetail(e.toString());}
      tr6.writeTo(writer);

      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_attributes1 */
      ...
      TestResult tr7 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_ATTRIBUTES1);
      try {
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_attributes1a */
      /* Details: "If the request dispatcher is obtained through the          */
      /* getRequestDispatcher method, the servlet request attribute           */
      /* javax.servlet.forward.request_uri will be set, and equals the        */
      /* value from HTTPServletRequest.getRequestURI for the first servlet    */
      /* in the forward chain"                                                */
      TestResult tr8 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_ATTRIBUTES1A);
      try {
         String name = "javax.servlet.forward.request_uri";
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_attributes1b */
      /* Details: "If the request dispatcher is obtained through the          */
      /* getRequestDispatcher method, the portlet request attribute           */
      /* javax.servlet.include.request_uri will not be set"                   */
      TestResult tr9 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_ATTRIBUTES1B);
      try {
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_attributes1c */
      /* Details: "If the request dispatcher is obtained through the          */
      /* getRequestDispatcher method, the servlet request attribute           */
      /* javax.servlet.include.request_uri will not be set"                   */
      TestResult tr10 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_ATTRIBUTES1C);
      try {
         String name = "javax.servlet.include.request_uri";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_attributes2 */
      /* Details: "If the request dispatcher is obtained through the          */
      /* getRequestDispatcher method, the portlet request attribute           */
      ...
      /* in the forward chain"                                                */
      TestResult tr11 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_ATTRIBUTES2);
      try {
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_attributes2a */
      /* Details: "If the request dispatcher is obtained through the          */
      /* getRequestDispatcher method, the servlet request attribute           */
      /* javax.servlet.forward.context_path will be set, and equals the       */
      /* value from HTTPServletRequest.getContextPath for the first servlet   */
      /* in the forward chain"                                                */
      TestResult tr12 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_ATTRIBUTES2A);
      try {
         String name = "javax.servlet.forward.context_path";
         String attrVal = (String) request.getAttribute(name);
         String currVal =  request.getContextPath();
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_attributes2b */
      /* Details: "If the request dispatcher is obtained through the          */
      /* getRequestDispatcher method, the portlet request attribute           */
      /* javax.servlet.include.context_path will not be set"                  */
      TestResult tr13 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_ATTRIBUTES2B);
      try {
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_attributes2c */
      /* Details: "If the request dispatcher is obtained through the          */
      /* getRequestDispatcher method, the servlet request attribute           */
      /* javax.servlet.include.context_path will not be set"                  */
      TestResult tr14 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_ATTRIBUTES2C);
      try {
         String name = "javax.servlet.include.context_path";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_attributes3 */
      /* Details: "If the request dispatcher is obtained through the          */
      /* getRequestDispatcher method, the portlet request attribute           */
      ...
      /* in the forward chain"                                                */
      TestResult tr15 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_ATTRIBUTES3);
      try {
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_attributes3a */
      /* Details: "If the request dispatcher is obtained through the          */
      /* getRequestDispatcher method, the servlet request attribute           */
      /* javax.servlet.forward.servlet_path will be set, and equals the       */
      /* value from HTTPServletRequest.getServletPath for the first servlet   */
      /* in the forward chain"                                                */
      TestResult tr16 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_ATTRIBUTES3A);
      try {
         String name = "javax.servlet.forward.servlet_path";
         String attrVal = (String) request.getAttribute(name);
         String currVal =  request.getServletPath();
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_attributes3b */
      /* Details: "If the request dispatcher is obtained through the          */
      /* getRequestDispatcher method, the portlet request attribute           */
      /* javax.servlet.include.servlet_path will not be set"                  */
      TestResult tr17 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_ATTRIBUTES3B);
      try {
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_attributes3c */
      /* Details: "If the request dispatcher is obtained through the          */
      /* getRequestDispatcher method, the servlet request attribute           */
      /* javax.servlet.include.servlet_path will not be set"                  */
      TestResult tr18 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_ATTRIBUTES3C);
      try {
         String name = "javax.servlet.include.servlet_path";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_attributes4 */
      /* Details: "If the request dispatcher is obtained through the          */
      /* getRequestDispatcher method, the portlet request attribute           */
      ...
      /* forward chain"                                                       */
      TestResult tr19 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_ATTRIBUTES4);
      try {
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_attributes4a */
      /* Details: "If the request dispatcher is obtained through the          */
      /* getRequestDispatcher method, the servlet request attribute           */
      /* javax.servlet.forward.path_info will be set, and equals the value    */
      /* from HTTPServletRequest.getPathInfo for the first servlet in the     */
      /* forward chain"                                                       */
      TestResult tr20 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_ATTRIBUTES4A);
      try {
         String name = "javax.servlet.forward.path_info";
         String attrVal = (String) request.getAttribute(name);
         String currVal =  request.getPathInfo();
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_attributes4b */
      /* Details: "If the request dispatcher is obtained through the          */
      /* getRequestDispatcher method, the portlet request attribute           */
      /* javax.servlet.include.path_info will not be set"                     */
      TestResult tr21 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_ATTRIBUTES4B);
      try {
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_attributes4c */
      /* Details: "If the request dispatcher is obtained through the          */
      /* getRequestDispatcher method, the servlet request attribute           */
      /* javax.servlet.include.path_info will not be set"                     */
      TestResult tr22 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_ATTRIBUTES4C);
      try {
         String name = "javax.servlet.include.path_info";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_attributes5 */
      /* Details: "If the request dispatcher is obtained through the          */
      /* getRequestDispatcher method, the portlet request attribute           */
      ...
      /* in the forward chain"                                                */
      TestResult tr23 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_ATTRIBUTES5);
      try {
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_attributes5a */
      /* Details: "If the request dispatcher is obtained through the          */
      /* getRequestDispatcher method, the servlet request attribute           */
      /* javax.servlet.forward.query_string will be set, and equals the       */
      /* value from HTTPServletRequest.getQueryString for the first servlet   */
      /* in the forward chain"                                                */
      TestResult tr24 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_ATTRIBUTES5A);
      try {
         String name = "javax.servlet.forward.query_string";
         String attrVal = (String) request.getAttribute(name);
         String currVal =  request.getQueryString();
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_attributes5b */
      /* Details: "If the request dispatcher is obtained through the          */
      /* getRequestDispatcher method, the portlet request attribute           */
      /* javax.servlet.include.query_string will not be set"                  */
      TestResult tr25 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_ATTRIBUTES5B);
      try {
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_attributes5c */
      /* Details: "If the request dispatcher is obtained through the          */
      /* getRequestDispatcher method, the servlet request attribute           */
      /* javax.servlet.include.query_string will not be set"                  */
      TestResult tr26 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_ATTRIBUTES5C);
      try {
         String name = "javax.servlet.include.query_string";
         String attrVal = (String) request.getAttribute(name);
         // if (attrVal != null)
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_attributes6 */
      /* Details: "The request attribute javax.portlet.config must be set     */
      /* to the javax.portlet.PortletConfig object"                           */
      TestResult tr27 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_ATTRIBUTES6);
      try {
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_attributes7 */
      ...
      TestResult tr28 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_ATTRIBUTES7);
      try {
      ...
      /* TestCase: V2DispatcherTests2_SPEC2_19_ForwardJSPResource_attributes8 */
      /* Details: "For forwards from the serveResource method, The request    */
      /* attribute javax.portlet.response must be set to the                  */
      /* javax.portlet.ResourceResponse object"                               */
      TestResult tr29 = tcd.getTestResultFailed(V2DISPATCHERTESTS2_SPEC2_19_FORWARDJSPRESOURCE_ATTRIBUTES8);
      try {
