...
public class EnvironmentTests_CacheControl_ApiRender implements Portlet {
  ...
  public void render(RenderRequest portletReq, RenderResponse portletResp)
    ...
    TestResult tr0 =
        tcd.getTestResultFailed(V2ENVIRONMENTTESTS_CACHECONTROL_APIRENDER_GETEXPIRATIONTIME1);
    ...
    TestResult tr3 =
        tcd.getTestResultFailed(V2ENVIRONMENTTESTS_CACHECONTROL_APIRENDER_SETEXPIRATIONTIME1);
