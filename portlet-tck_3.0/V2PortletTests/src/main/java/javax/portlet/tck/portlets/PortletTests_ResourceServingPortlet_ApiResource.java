...
import static javax.portlet.tck.beans.JSR286ApiTestCaseDetails.V2PORTLETTESTS_RESOURCESERVINGPORTLET_APIRESOURCE_SERVERESOURCE;
 ...
 * PortletTests_ResourceServingPortlet_ApiResource_event
 *
 */
public class PortletTests_ResourceServingPortlet_ApiResource
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      writer.write(
            "<div id=\"PortletTests_ResourceServingPortlet_ApiResource\">no resource output.</div>\n");
      ...
      writer.write(
            "         document.getElementById(\"PortletTests_ResourceServingPortlet_ApiResource\").innerHTML=xhr.responseText;\n");
      writer.write("      }\n");
      writer.write("   };\n");
      writer.write(
