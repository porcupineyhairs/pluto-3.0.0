 ...
 * FilterTests_ResourceFilter_ApiResourceFilter_event
 *
 */
public class FilterTests_ResourceFilter_ApiResourceFilter
  ...
  public void serveResource(ResourceRequest portletReq, ResourceResponse portletResp)
    ...
    /* for the portlet" */
    TestResult tr2 =
        tcd.getTestResultFailed(V2FILTERTESTS_RESOURCEFILTER_APIRESOURCEFILTER_DOFILTERISCALLED);
    if (FilterTests_ResourceFilter_ApiResourceFilter_filter2.tr2_success) {
    ...
    if (FilterTests_ResourceFilter_ApiResourceFilter_filter2.tr3_success) {
  ...
  public void render(RenderRequest portletReq, RenderResponse portletResp)
    ...
    writer.write(
        "<div id=\"FilterTests_ResourceFilter_ApiResourceFilter\">no resource output.</div>\n");
    ...
    writer.write(
        "         document.getElementById(\"FilterTests_ResourceFilter_ApiResourceFilter\").innerHTML=xhr.responseText;\n");
    writer.write("      }\n");
    writer.write("   };\n");
