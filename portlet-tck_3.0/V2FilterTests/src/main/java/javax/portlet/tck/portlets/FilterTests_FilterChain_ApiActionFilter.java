 ...
 * FilterTests_FilterChain_ApiActionFilter_event
 *
 */
public class FilterTests_FilterChain_ApiActionFilter implements Portlet {
  ...
  public void render(RenderRequest portletReq, RenderResponse portletResp)
    ...
    if (msg != null) {
      ...
      ps.removeAttribute(RESULT_ATTR_PREFIX + "FilterTests_FilterChain_ApiActionFilter",
          APPLICATION_SCOPE);
    }
