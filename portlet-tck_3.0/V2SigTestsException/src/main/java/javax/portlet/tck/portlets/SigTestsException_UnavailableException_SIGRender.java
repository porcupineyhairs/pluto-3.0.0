 ...
 * SigTestsException_UnavailableException_SIGRender_event
 *
 */
public class SigTestsException_UnavailableException_SIGRender implements Portlet {
  ...
  public void render(RenderRequest portletReq, RenderResponse portletResp)
    ...
    TestResult tr0 =
        tcd.getTestResultFailed(V2SIGTESTSEXCEPTION_UNAVAILABLEEXCEPTION_SIGRENDER_CONSTRUCTOR);
    try {
    ...
    /* TestCase: V2SigTestsException_UnavailableException_SIGRender_constructorA */
    /* Details: "UnavailableException provides constructor */
    /* UnavailableException(String, int) " */
    TestResult tr1 =
        tcd.getTestResultFailed(V2SIGTESTSEXCEPTION_UNAVAILABLEEXCEPTION_SIGRENDER_CONSTRUCTORA);
    try {
    ...
    /* TestCase: V2SigTestsException_UnavailableException_SIGRender_extendsPortletException */
    /* Details: "UnavailableException extends PortletException " */
    TestResult tr2 = tcd.getTestResultFailed(
        V2SIGTESTSEXCEPTION_UNAVAILABLEEXCEPTION_SIGRENDER_EXTENDSPORTLETEXCEPTION);
    try {
      tr2.setTcSuccess(cc.hasSuperclass(PortletException.class));
    } catch (Exception e) {
      tr2.appendTcDetail(e.toString());
    }
    tr2.writeTo(writer);

    /* TestCase: V2SigTestsException_UnavailableException_SIGRender_hasGetUnavailableSeconds */
    /* Details: "UnavailableException has a getUnavailableSeconds() */
    /* method " */
    TestResult tr3 = tcd.getTestResultFailed(
        V2SIGTESTSEXCEPTION_UNAVAILABLEEXCEPTION_SIGRENDER_HASGETUNAVAILABLESECONDS);
    try {
    ...
    /*
     * TestCase: V2SigTestsException_UnavailableException_SIGRender_hasGetUnavailableSecondsReturns
     */
    /* Details: "UnavailableException method getUnavailableSeconds() */
    /* returns int " */
    TestResult tr4 = tcd.getTestResultFailed(
        V2SIGTESTSEXCEPTION_UNAVAILABLEEXCEPTION_SIGRENDER_HASGETUNAVAILABLESECONDSRETURNS);
    try {
      String name = "getUnavailableSeconds";
    ...
    /* TestCase: V2SigTestsException_UnavailableException_SIGRender_hasIsPermanent */
    /* Details: "UnavailableException has a isPermanent()  method " */
    TestResult tr5 =
        tcd.getTestResultFailed(V2SIGTESTSEXCEPTION_UNAVAILABLEEXCEPTION_SIGRENDER_HASISPERMANENT);
    try {
    ...
    /* TestCase: V2SigTestsException_UnavailableException_SIGRender_hasIsPermanentReturns */
    /* Details: "UnavailableException method isPermanent() returns */
    /* boolean " */
    TestResult tr6 = tcd.getTestResultFailed(
        V2SIGTESTSEXCEPTION_UNAVAILABLEEXCEPTION_SIGRENDER_HASISPERMANENTRETURNS);
    try {
      String name = "isPermanent";
