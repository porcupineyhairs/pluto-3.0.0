 ...
 * SigTestsException_PortletSecurityException_SIGRender_event
 *
 */
public class SigTestsException_PortletSecurityException_SIGRender implements Portlet {
  ...
  public void render(RenderRequest portletReq, RenderResponse portletResp)
    ...
    TestResult tr0 =
        tcd.getTestResultFailed(V2SIGTESTSEXCEPTION_PORTLETSECURITYEXCEPTION_SIGRENDER_CONSTRUCTOR);
    try {
    ...
    TestResult tr1 = tcd
        .getTestResultFailed(V2SIGTESTSEXCEPTION_PORTLETSECURITYEXCEPTION_SIGRENDER_CONSTRUCTORA);
    try {
    ...
    TestResult tr2 = tcd
        .getTestResultFailed(V2SIGTESTSEXCEPTION_PORTLETSECURITYEXCEPTION_SIGRENDER_CONSTRUCTORB);
    try {
    ...
    TestResult tr3 = tcd.getTestResultFailed(
        V2SIGTESTSEXCEPTION_PORTLETSECURITYEXCEPTION_SIGRENDER_EXTENDSPORTLETEXCEPTION);
    try {
