 ...
 * SigTestsEvent_EventResponse_SIGEvent_event
 *
 */
public class SigTestsEvent_EventResponse_SIGEvent implements Portlet {
  ...
  public void processAction(ActionRequest portletReq, ActionResponse portletResp)
    ...
    QName eventQName = new QName(TCKNAMESPACE, "SigTestsEvent_EventResponse_SIGEvent");
  ...
  public void render(RenderRequest portletReq, RenderResponse portletResp)
    ...
    /* returns void " */
    {
      ...
      TestButton tb = new TestButton(
          "V2SigTestsEvent_EventResponse_SIGEvent_hasSetRenderParametersReturns", aurl);
      tb.writeTo(writer);
    }
    ...
    /* Details: "EventResponse implements StateAwareResponse " */
    {
      ...
      aurl.setParameters(portletReq.getPrivateParameterMap());
      TestButton tb = new TestButton(
          "V2SigTestsEvent_EventResponse_SIGEvent_implementsStateAwareResponse", aurl);
      tb.writeTo(writer);
    }
