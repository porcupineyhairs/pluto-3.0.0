...
import static javax.portlet.tck.beans.JSR286DispatcherTestCaseDetails.V2DISPATCHERTESTS3S_SPEC2_19_INCLUDEJSPRENDER_DISPATCH4;
 ...
 * DispatcherTests3S_SPEC2_19_IncludeJSPRender_event
 * 
 */
public class DispatcherTests3S_SPEC2_19_IncludeJSPRender implements Portlet, ResourceServingPortlet {
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp) throws PortletException, IOException {
      ...
      String target = JSP_PREFIX + "DispatcherTests3S_SPEC2_19_IncludeJSPRender" + JSP_SUFFIX + "?" + QUERY_STRING;
      ...
      /* TestCase: DispatcherTests3S_SPEC2_19_IncludeJSPRender_dispatch4 */
      /* Details: "The parameters associated with a request dispatcher are */
      /* scoped only for the duration of the include or forward call" */
      TestResult tr0 = tcd.getTestResultFailed(V2DISPATCHERTESTS3S_SPEC2_19_INCLUDEJSPRENDER_DISPATCH4);
