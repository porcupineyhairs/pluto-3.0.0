...
import static javax.portlet.tck.beans.JSR286DispatcherTestCaseDetails.V2DISPATCHERTESTS3S_SPEC2_19_FORWARDJSPEVENT_DISPATCH4;
 ...
 */
public class DispatcherTests3S_SPEC2_19_ForwardJSPEvent_event implements Portlet, EventPortlet, ResourceServingPortlet {
   ...
   public void processEvent(EventRequest portletReq, EventResponse portletResp) throws PortletException, IOException {
      ...
      String target = JSP_PREFIX + "DispatcherTests3S_SPEC2_19_ForwardJSPEvent" + JSP_SUFFIX + "?" + QUERY_STRING;
      ...
      /* TestCase: DispatcherTests3S_SPEC2_19_ForwardJSPEvent_dispatch4 */
      /* Details: "The parameters associated with a request dispatcher are */
      /* scoped only for the duration of the include or forward call" */
      TestResult tr0 = tcd.getTestResultFailed(V2DISPATCHERTESTS3S_SPEC2_19_FORWARDJSPEVENT_DISPATCH4);
      CompareUtils.mapsEqual("Before dispatch", oldmap, "After dispatch", newmap, tr0);
      tr0.writeTo(writer);

      portletReq.getPortletSession().setAttribute(
            Constants.RESULT_ATTR_PREFIX + V2DISPATCHERTESTS3S_SPEC2_19_FORWARDJSPEVENT_DISPATCH4, writer.toString(),
            APPLICATION_SCOPE);
