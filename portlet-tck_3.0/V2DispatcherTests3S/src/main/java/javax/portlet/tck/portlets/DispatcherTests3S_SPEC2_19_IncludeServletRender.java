...
import static javax.portlet.tck.beans.JSR286DispatcherTestCaseDetails.V2DISPATCHERTESTS3S_SPEC2_19_INCLUDESERVLETRENDER_DISPATCH4;
 ...
 * DispatcherTests3S_SPEC2_19_IncludeServletRender_event
 * 
 */
public class DispatcherTests3S_SPEC2_19_IncludeServletRender implements Portlet, ResourceServingPortlet {
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp) throws PortletException, IOException {
      ...
      String target = SERVLET_PREFIX + "DispatcherTests3S_SPEC2_19_IncludeServletRender_servlet" + SERVLET_SUFFIX + "?"
            + QUERY_STRING;
      ...
      /* TestCase: DispatcherTests3S_SPEC2_19_IncludeServletRender_dispatch4 */
      /* Details: "The parameters associated with a request dispatcher are */
      /* scoped only for the duration of the include or forward call" */
      TestResult tr0 = tcd.getTestResultFailed(V2DISPATCHERTESTS3S_SPEC2_19_INCLUDESERVLETRENDER_DISPATCH4);
