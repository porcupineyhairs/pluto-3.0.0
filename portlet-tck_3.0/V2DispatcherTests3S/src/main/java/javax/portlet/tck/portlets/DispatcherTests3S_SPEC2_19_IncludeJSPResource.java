...
import static javax.portlet.tck.beans.JSR286DispatcherTestCaseDetails.V2DISPATCHERTESTS3S_SPEC2_19_INCLUDEJSPRESOURCE_DISPATCH4;
 ...
 * DispatcherTests3S_SPEC2_19_IncludeJSPResource_event
 * 
 */
public class DispatcherTests3S_SPEC2_19_IncludeJSPResource implements Portlet, ResourceServingPortlet {
   ...
   public void serveResource(ResourceRequest portletReq, ResourceResponse portletResp) throws PortletException,
      ...
      String target = JSP_PREFIX + "DispatcherTests3S_SPEC2_19_IncludeJSPResource" + JSP_SUFFIX + "?" + QUERY_STRING;
      ...
      /* TestCase: DispatcherTests3S_SPEC2_19_IncludeJSPResource_dispatch4 */
      /* Details: "The parameters associated with a request dispatcher are */
      /* scoped only for the duration of the include or forward call" */
      TestResult tr0 = tcd.getTestResultFailed(V2DISPATCHERTESTS3S_SPEC2_19_INCLUDEJSPRESOURCE_DISPATCH4);
