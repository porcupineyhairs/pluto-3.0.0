 ...
 */
public class DispatcherTests3S_SPEC2_19_IncludeServletEvent_event implements Portlet, EventPortlet,
   ...
   public void processEvent(EventRequest portletReq, EventResponse portletResp) throws PortletException, IOException {
      ...
      String target = SERVLET_PREFIX + "DispatcherTests3S_SPEC2_19_IncludeServletEvent_servlet" + SERVLET_SUFFIX + "?"
            + QUERY_STRING;
      ...
      /* TestCase: DispatcherTests3S_SPEC2_19_IncludeServletEvent_dispatch4 */
      /* Details: "The parameters associated with a request dispatcher are */
      /* scoped only for the duration of the include or forward call" */
      TestResult tr0 = tcd.getTestResultFailed(V2DISPATCHERTESTS3S_SPEC2_19_INCLUDESERVLETEVENT_DISPATCH4);
      CompareUtils.mapsEqual("Before dispatch", oldmap, "After dispatch", newmap, tr0);
      tr0.writeTo(writer);

      portletReq.getPortletSession().setAttribute(
            Constants.RESULT_ATTR_PREFIX + V2DISPATCHERTESTS3S_SPEC2_19_INCLUDESERVLETEVENT_DISPATCH4,
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp) throws PortletException, IOException {
      ...
      writer.write("<p>DispatcherTests3S_SPEC2_19_IncludeServletEvent_event</p>\n");

      String msg = (String) portletReq.getPortletSession().getAttribute(
            RESULT_ATTR_PREFIX + V2DISPATCHERTESTS3S_SPEC2_19_INCLUDESERVLETEVENT_DISPATCH4, APPLICATION_SCOPE);
