...
import static javax.portlet.tck.beans.JSR286DispatcherTestCaseDetails.V2DISPATCHERTESTS3S_SPEC2_19_FORWARDJSPRESOURCE_DISPATCH4;
 ...
 * DispatcherTests3S_SPEC2_19_ForwardJSPResource_event
 * 
 */
public class DispatcherTests3S_SPEC2_19_ForwardJSPResource implements Portlet, ResourceServingPortlet {
   ...
   public void serveResource(ResourceRequest portletReq, ResourceResponse portletResp) throws PortletException,
      ...
      String target = JSP_PREFIX + "DispatcherTests3S_SPEC2_19_ForwardJSPResource" + JSP_SUFFIX + "?" + QUERY_STRING;
      ...
      /* TestCase: DispatcherTests3S_SPEC2_19_ForwardJSPResource_dispatch4 */
      ...
      portletReq.getPortletSession().setAttribute(
            Constants.RESULT_ATTR_PREFIX + V2DISPATCHERTESTS3S_SPEC2_19_FORWARDJSPRESOURCE_DISPATCH4, 
            writer.toString(),
            APPLICATION_SCOPE);
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp) throws PortletException, IOException {
      ...
      String msg = (String) portletReq.getPortletSession().getAttribute(
            RESULT_ATTR_PREFIX + V2DISPATCHERTESTS3S_SPEC2_19_FORWARDJSPRESOURCE_DISPATCH4, APPLICATION_SCOPE);
      ...
      if (msg == null) {
         ...
         writer.write("         document.getElementById(\"DispatcherTests3S_SPEC2_19_FORWARDJSPRESOURCE\").innerHTML=xhr.responseText;\n");
         writer.write("      }\n");
         writer.write("   };\n");
