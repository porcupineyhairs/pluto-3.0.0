 ...
 * WrapperTests_EventResponseWrapper_ApiEvent_event
 *
 */
public class WrapperTests_EventResponseWrapper_ApiEvent implements Portlet {
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp)
      ...
      /* java.io.Serializable): Calls wrapped method" */
      {
         ...
         TestButton tb = new TestButton(
               "V2WrapperTests_EventResponseWrapper_ApiEvent_setEventA", aurl);
         tb.writeTo(writer);
      }
      ...
      /* wrapped method" */
      {
         ...
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton(
               "V2WrapperTests_EventResponseWrapper_ApiEvent_setEventB", aurl);
         tb.writeTo(writer);
      }
