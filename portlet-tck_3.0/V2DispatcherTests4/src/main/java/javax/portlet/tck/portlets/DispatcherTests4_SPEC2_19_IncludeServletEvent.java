 ...
 * DispatcherTests4_SPEC2_19_IncludeServletEvent_event
 * 
 */
public class DispatcherTests4_SPEC2_19_IncludeServletEvent implements Portlet, ResourceServingPortlet {
   ...
   public void processAction(ActionRequest portletReq, ActionResponse portletResp) throws PortletException, IOException {
      ...
      QName eventQName = new QName(TCKNAMESPACE, "DispatcherTests4_SPEC2_19_IncludeServletEvent");
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp) throws PortletException, IOException {
      ...
      /* lifecyle method initiating the include" */
      {
         ...
         TestButton tb = new TestButton(V2DISPATCHERTESTS4_SPEC2_19_INCLUDESERVLETEVENT_INVOKE3, aurl);
         tb.writeTo(writer);
      }
      ...
      /* same lifecycle method" */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton(V2DISPATCHERTESTS4_SPEC2_19_INCLUDESERVLETEVENT_INVOKE8, aurl);
         tb.writeTo(writer);
      }
