 ...
 * DispatcherTests4_SPEC2_19_IncludeJSPResource_event
 * 
 */
public class DispatcherTests4_SPEC2_19_IncludeJSPResource implements Portlet, ResourceServingPortlet {
   ...
   public void serveResource(ResourceRequest portletReq, ResourceResponse portletResp) throws PortletException,
      ...
      // Prereq for: V2DispatcherTests4_SPEC2_19_IncludeJSPResource_invoke3
      portletReq = new ResourceRequestWrapper(portletReq);
      portletResp = new ResourceResponseWrapper(portletResp);

      {
         // Prereq for: V2DispatcherTests4_SPEC2_19_IncludeJSPResource_invoke8
      ...
      String target = JSP_PREFIX + "DispatcherTests4_SPEC2_19_IncludeJSPResource" + JSP_SUFFIX + "?" + QUERY_STRING;
      PortletRequestDispatcher rd = portletConfig.getPortletContext().getRequestDispatcher(target);
      rd.include(portletReq, portletResp);
   }
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp) throws PortletException, IOException {
      ...
      writer.write("<div id=\"DispatcherTests4_SPEC2_19_IncludeJSPResource\">no resource output.</div>\n");
      ...
      writer.write("         document.getElementById(\"DispatcherTests4_SPEC2_19_IncludeJSPResource\").innerHTML=xhr.responseText;\n");
      writer.write("      }\n");
      writer.write("   };\n");
