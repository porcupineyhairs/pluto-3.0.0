...
import static javax.portlet.tck.beans.JSR286DispatcherTestCaseDetails.V2DISPATCHERTESTS4_SPEC2_19_INCLUDEJSPACTION_INVOKE3;
import static javax.portlet.tck.beans.JSR286DispatcherTestCaseDetails.V2DISPATCHERTESTS4_SPEC2_19_INCLUDEJSPACTION_INVOKE8;
...
public class DispatcherTests4_SPEC2_19_IncludeJSPAction implements Portlet, ResourceServingPortlet {
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp) throws PortletException, IOException {
      ...
      /* lifecyle method initiating the include" */
      {
         ...
         TestButton tb = new TestButton(V2DISPATCHERTESTS4_SPEC2_19_INCLUDEJSPACTION_INVOKE3, aurl);
         tb.writeTo(writer);
      }
      ...
      /* same lifecycle method" */
      {
         PortletURL aurl = portletResp.createActionURL();
         aurl.setParameters(portletReq.getPrivateParameterMap());
         TestButton tb = new TestButton(V2DISPATCHERTESTS4_SPEC2_19_INCLUDEJSPACTION_INVOKE8, aurl);
         tb.writeTo(writer);
      }
