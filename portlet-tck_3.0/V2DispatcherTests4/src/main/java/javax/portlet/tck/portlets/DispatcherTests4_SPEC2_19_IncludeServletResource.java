 ...
 * DispatcherTests4_SPEC2_19_IncludeServletResource_event
 * 
 */
public class DispatcherTests4_SPEC2_19_IncludeServletResource implements Portlet, ResourceServingPortlet {
   ...
   public void serveResource(ResourceRequest portletReq, ResourceResponse portletResp) throws PortletException,
      ...
      String target = SERVLET_PREFIX + "DispatcherTests4_SPEC2_19_IncludeServletResource_servlet" + SERVLET_SUFFIX
            + "?" + QUERY_STRING;
      PortletRequestDispatcher rd = portletConfig.getPortletContext().getRequestDispatcher(target);
      rd.include(portletReq, portletResp);
   }
