 ...
 */
public class DispatcherTests4_SPEC2_19_IncludeJSPEvent_event implements Portlet, EventPortlet, ResourceServingPortlet {
   ...
   public void processEvent(EventRequest portletReq, EventResponse portletResp) throws PortletException, IOException {
      ...
      // Prereq for: V2DispatcherTests4_SPEC2_19_IncludeJSPEvent_invoke3
      portletReq = new EventRequestWrapper(portletReq);
      portletResp = new EventResponseWrapper(portletResp);

      {
         // Prereq for: V2DispatcherTests4_SPEC2_19_IncludeJSPEvent_invoke8
      ...
      String target = JSP_PREFIX + "DispatcherTests4_SPEC2_19_IncludeJSPEvent" + JSP_SUFFIX + "?" + QUERY_STRING;
      PortletRequestDispatcher rd = portletConfig.getPortletContext().getRequestDispatcher(target);
      rd.include(portletReq, portletResp);
