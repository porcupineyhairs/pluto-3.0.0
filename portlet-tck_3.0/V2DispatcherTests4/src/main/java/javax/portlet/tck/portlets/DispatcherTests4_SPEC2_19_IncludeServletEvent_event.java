 ...
 */
public class DispatcherTests4_SPEC2_19_IncludeServletEvent_event implements Portlet, EventPortlet,
   ...
   public void processEvent(EventRequest portletReq, EventResponse portletResp) throws PortletException, IOException {
      ...
      // Prereq for: V2DispatcherTests4_SPEC2_19_IncludeServletEvent_invoke3
      portletReq = new EventRequestWrapper(portletReq);
      portletResp = new EventResponseWrapper(portletResp);

      {
         // Prereq for: V2DispatcherTests4_SPEC2_19_IncludeServletEvent_invoke8
      ...
      String target = SERVLET_PREFIX + "DispatcherTests4_SPEC2_19_IncludeServletEvent_servlet" + SERVLET_SUFFIX + "?"
            + QUERY_STRING;
      PortletRequestDispatcher rd = portletConfig.getPortletContext().getRequestDispatcher(target);
      rd.include(portletReq, portletResp);
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp) throws PortletException, IOException {
      ...
      writer.write("<p>DispatcherTests4_SPEC2_19_IncludeServletEvent_event</p>\n");

      String msg = (String) portletReq.getPortletSession().getAttribute(
            RESULT_ATTR_PREFIX + "DispatcherTests4_SPEC2_19_IncludeServletEvent", APPLICATION_SCOPE);
