 ...
 * DispatcherTests4_SPEC2_19_IncludeJSPRender_event
 * 
 */
public class DispatcherTests4_SPEC2_19_IncludeJSPRender implements Portlet, ResourceServingPortlet {
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp) throws PortletException, IOException {
      ...
      // Prereq for: V2DispatcherTests4_SPEC2_19_IncludeJSPRender_invoke3
      portletReq = new RenderRequestWrapper(portletReq);
      portletResp = new RenderResponseWrapper(portletResp);

      {
         // Prereq for: V2DispatcherTests4_SPEC2_19_IncludeJSPRender_invoke8
      ...
      String target = JSP_PREFIX + "DispatcherTests4_SPEC2_19_IncludeJSPRender" + JSP_SUFFIX + "?" + QUERY_STRING;
      PortletRequestDispatcher rd = portletConfig.getPortletContext().getRequestDispatcher(target);
      rd.include(portletReq, portletResp);
   }
