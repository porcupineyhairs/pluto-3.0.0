...
/**
 * Servlet for JSR 362 request dispatcher testing. Used by portlet: DispatcherTests4_SPEC2_19_IncludeServletAction
 * 
 * @author nick
 * 
 */
public class DispatcherTests4_SPEC2_19_IncludeServletAction_servlet extends HttpServlet {
   ...
   protected void processTCKReq(HttpServletRequest request, HttpServletResponse response) throws ServletException,
      ...
      request.getSession().setAttribute(
            Constants.RESULT_ATTR_PREFIX + "DispatcherTests4_SPEC2_19_IncludeServletAction", writer.toString());
